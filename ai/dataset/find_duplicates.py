...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, help="Path to downloaded datasets")
    ...
    print(
        f"Found {len(duplicates)} duplicate pairs (total {sum(len(files) for files in duplicates)} images)"
    )
