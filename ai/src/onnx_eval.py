...
def parse_args():
    ...
    parser.add_argument("--onnx_path", type=str, default="models/model_quantized.onnx", help="Path to save ONNX model")
    parser.add_argument(
        "--dataset_path",
        type=str,
...
if __name__ == "__main__":
    ...
    # ONNX 평가기 초기화
    evaluator = ONNXImageTestEvaluator(onnx_path=args.onnx_path, dataset_path=args.dataset_path, image_size=(224, 224))
