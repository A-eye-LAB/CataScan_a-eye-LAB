...
final eyeDetectionModelSessionProvider = FutureProvider.autoDispose<OrtSession>((ref) async {
  OrtEnv.instance.init();
  final sessionOptions = OrtSessionOptions();
  final rawAssetFile = await rootBundle.load(EyeDetectionModelConfig.modelUrl);
