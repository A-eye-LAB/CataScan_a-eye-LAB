...
class CenterTermsOfServiceScreen extends ConsumerWidget {
  const CenterTermsOfServiceScreen({super.key});
  static const String routeName = '/center_terms_of_service';
